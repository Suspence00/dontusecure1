document.addEventListener('DOMContentLoaded', function () {
    ...
    let isReversed = false; // Track the state of the Easter egg
    ...
    function activateEasterEgg() {
        isReversed = !isReversed; // Toggle the Easter egg state
        document.body.classList.toggle('reverse-mode');
        swapTextContent(isReversed);
        audio.play();
    }
    ...
    function loadDefaultContent() {
        ...
        headerText.innerHTML = `
            ...
            STOP USING <span class="cure1">Cure 1</span>, USE <span class="cure2-header">Cure 2</span>
            <img src="48px-Cure_II_Icon.png" alt="Cure 2 Icon">
        `;

        const topBit = document.querySelector('#top-bit');
        if (topBit) topBit.remove(); // Remove existing top bit to avoid duplication

        const topBitContent = document.createElement('div');
        topBitContent.id = 'top-bit'; // Set an ID to avoid duplication
        ...
        tldrText.innerHTML = `
            <h2>TL;DR</h2>
            <p>Once you unlock <span class="cure2">Cure 2</span> at level 30, you should always use it instead of <span class="cure1">Cure 1</span>.</p>
            <p><span class="cure2">Cure 2</span> heals for 700 potency and is the better choice in almost every situation.</p>
            <p><b>Use <span class="cure2">Cure 2</span>. Don’t use <span class="cure1">Cure 1</span> just to save MP or try for Freecure procs.</b></p>
        `;
        ...
        const detailedText = document.querySelector('#detailed');
        ...
        const freecureText = document.querySelector('#freecure');
        freecureText.innerHTML = `
            <h2>Why Relying on Freecure is a Trap</h2>
        ...
        const mpManagementText = document.querySelector('#mp-management');
        mpManagementText.innerHTML = `
            <h2>But What About MP?</h2>
            <p>One concern might be the higher MP cost of <span class="cure2">Cure 2</span> (1000 MP compared to <span class="cure1">Cure 1</span>'s 400 MP). However, White Mages have access to <img src="48px-Lucid_Dreaming_Icon.png" alt="Lucid Dreaming Icon"> <strong>Lucid Dreaming</strong>, an ability that regenerates MP over time.
            </p>
            <ul>
        ...
        const castRecastText = document.querySelector('#cast-recast-times');
        castRecastText.innerHTML = `
            <h2>Understanding Cast Time vs. Recast Time</h2>
            <p>
                Even though <span class="cure1">Cure 1</span> has a shorter cast time than <span class="cure2">Cure 2</span>, it’s important to understand the difference between cast time and recast time:
            </p>
            <ul>
        ...
        ifSomeoneText.innerHTML = `
            ...
            <p>
                The intent behind this guide isn’t to criticize or belittle anyone’s gameplay. This is a niche, overly detailed guide to be shared amongst the community to help everyone be better.
                This isn't meant to be taken hyper seriously, as in higher-level content you will have oGCDs and Lillies to compensate for healing and should rarely need to use Cure 2 at all.
                This is most relevant in late-ARR content where Cure 1 spam can lead to rocky Stone Vigils.
            </p>
            <p>
                It’s not toxic or negative to want to help others improve; in fact, it’s a sign of respect and camaraderie. Taking a moment to learn and adjust can make a huge difference not just for you, but for your entire party.
                May our healers be optimal and our tanks and DPS sustained!
            </p>
        `;
        ...
        loadTimeDisplay.innerHTML = `
            ...
            <a href="https://twitter.com/MajorPropsYT" target="_blank">X @MajorPropsYT</a>
        `;
        ifSomeoneText.appendChild(loadTimeDisplay);
    }

    function swapTextContent(isReversed) {
        if (isReversed) {
            ...
            tldrText.innerHTML = `
                <h2>TL;DR</h2>
                <p>Once you unlock <span class="cure1">Cure 1</span> at level 2, you should always use it instead of <span class="cure2">Cure 2</span>.</p>
                <p><span class="cure1">Cure 1</span> heals for 400 potency but is more MP efficient and allows for Freecure procs.</p>
                <p><b>Use <span class="cure1">Cure 1</span>. Don’t use <span class="cure2">Cure 2</span> unless you have a Freecure proc.</b></p>
            `;

            const freecureTab = document.querySelector('button[onclick*="openTab(\'freecure\'"]');
            freecureTab.textContent = "Freecure = Lifesaver";

            const freecureText = document.querySelector('#freecure');
            freecureText.innerHTML = `
                <h2>Why Freecure is a Lifesaver</h2>
            ...
            castRecastText.innerHTML = `
                ...
                <p>
                    While <span class="cure2">Cure 2</span> has higher potency, <span class="cure1">Cure 1</span> allows for quicker cast times and the chance for Freecure procs, making it a more versatile and MP-efficient choice in many scenarios.
                </p>
                <p><a href="#tabbed-content"><u>To Top</u></a></p>
            `;
            ...
            ifSomeoneText.innerHTML = `
                ...
                <p>
                    The intent behind this guide isn’t to criticize or belittle anyone’s gameplay. This is a niche, overly detailed guide to be shared amongst the community to help everyone be better.
                    This isn't meant to be taken hyper seriously, as in higher-level content you will have oGCDs and Lillies to compensate for healing and should rarely need to use Cure 1 at all.
                    This is most relevant in late-ARR content where Cure 2 spam can lead to unnecessary MP wastage.
                </p>
                <p>
                    It’s not toxic or negative to want to help others improve; in fact, it’s a sign of respect and camaraderie. Taking a moment to learn and adjust can make a huge difference not just for you, but for your entire party.
                    May our healers be optimal and our tanks and DPS sustained!
            ...
            const detailedText = document.querySelector('#detailed');
            detailedText.innerHTML = `
                <h2>In-Depth Explanation: Why <span class="cure1">Cure 1</span> is Better</h2>
            ...
            // Revert the tab name back to "Why Freecure is a Trap"
            const freecureTab = document.querySelector('button[onclick*="openTab(\'freecure\'"]');
            freecureTab.textContent = "Why Freecure is a Trap";
        }
        document.querySelectorAll('a[href="#tabbed-content"]').forEach(anchor => {
            anchor.addEventListener('click', function (e) {
                e.preventDefault();
                document.querySelector('#tabbed-content').scrollIntoView({ behavior: 'smooth' });
            });
        });
    }
